...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image `gucciPants`.
    static let gucciPants = Rswift.ImageResource(bundle: R.hostingBundle, name: "gucciPants")
    /// Image `homeImage`.
    ...
    /// Image `lvPants`.
    static let lvPants = Rswift.ImageResource(bundle: R.hostingBundle, name: "lvPants")
    /// Image `pradaPants`.
    static let pradaPants = Rswift.ImageResource(bundle: R.hostingBundle, name: "pradaPants")
    /// Image `profileImage`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "gucciPants", bundle: ..., traitCollection: ...)`
    static func gucciPants(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.gucciPants, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "lvPants", bundle: ..., traitCollection: ...)`
    static func lvPants(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.lvPants, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "pradaPants", bundle: ..., traitCollection: ...)`
    static func pradaPants(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.pradaPants, compatibleWith: traitCollection)
    }
    #endif
